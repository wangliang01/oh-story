...
| 构思小说 | 构思、想个故事、帮我设计人物/情节/世界观、接着上次继续构思 | `/story-conception` |
| 定卖点/基调 | 一句话卖点、这本书给谁看、基调怎么定 | `/story-premise` |
| 平台规则 | 盐选标准、番茄黄金三章、平台×篇幅规则、男频向 | `/story-platform` |
| 人设设计 | 人设、设计人物、主角三要素、反派 | `/story-character` |
| 世界观设定 | 世界观、力量体系、设定自洽、代入感 | `/story-world` |
| 情节/大纲构思 | 搭情节、冲突设计、节奏安排、三层结构 | `/story-plot` |
| 签约级验证 | 能签约吗、签约标准、会不会平庸、调教我的 skill | `/story-qualify` |
| 评审救场 | 写崩了、人设崩了、按模板自查、救场 | `/story-validate` |
| 学习语料 | 学习范文、吸收语料、更新基线 | `/story-learn` |
